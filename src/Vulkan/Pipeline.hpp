...
private:
    ...
    vk::DescriptorSet createTextureSamplerDescriptor(Device* device, Texture* texture, vk::DescriptorSetLayout descriptorSetLayout, vk::DescriptorSet descriptorSet);
};
